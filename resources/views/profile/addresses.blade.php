<x-profile-layout :sidebar="$sidebar" :page-title="$pageTitle" subtitle="Manage shipping addresses for faster checkout.">
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h2 class="h6 fw-semibold mb-1">Add New Address</h2>
                    <p class="text-muted small mb-0">Save addresses you use frequently.</p>
                </div>
            </div>
            <form action="{{ route('profile.addresses.store') }}" method="POST" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="label" value="{{ old('label') }}" class="form-control @error('label') is-invalid @enderror" placeholder="Home / Office">
                    @error('label')
                ...
                <div class="col-12 d-flex justify-content-end">
                    <button class="btn btn-primary px-4">Save Address</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h2 class="h6 fw-semibold mb-1">Saved Addresses</h2>
                    <p class="text-muted small mb-0">Edit, delete, or mark an address as default.</p>
                </div>
            </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center gap-2 mb-1">
                                <span class="fw-semibold">{{ $address->label ?? 'Address' }}</span>
